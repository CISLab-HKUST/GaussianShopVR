...
namespace GSShopUI
{
    public class ColorPickerSelector : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            m.uv = new Vector2[] { new Vector2(0, 0), new Vector2(0, 1), new Vector2(1, .5f), };
        ...
        public Vector3 GetValueFromHit(RaycastHit hit)
        {
            ...
            return new Vector3(localHitPoint.x + 0.5f, localHitPoint.y + 0.5f, RawValue.z);
        }
